...
curl -O https://raw.githubusercontent.com/realizer-vault/openvpn-install/master/openvpn-install.sh
chmod +x openvpn-install.sh
# wireguard-install.sh file
curl -O https://raw.githubusercontent.com/realizer-vault/wireguard-install/master/wireguard-install.sh
